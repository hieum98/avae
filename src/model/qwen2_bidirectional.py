...
class BidirectionalQwen2(Qwen2Model):
    """
    This class inherits from Qwen2Model and overrides the forward method to support bidirectional attention."
    """
    ...
    def forward(
        ...
        **flash_attn_kwargs,
        ...
        # Modified
        # We modify the attention mask to be make the model bidirectional
        attn_mask = self._update_attention_mask(
